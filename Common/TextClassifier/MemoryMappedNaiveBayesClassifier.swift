...
public class MemoryMappedNaiveBayesClassifier: TrainableTextClassifier {
    ...
    public static func train(with preprocessor: Preprocessor, on dataset: Dataset) -> TextClassifier {
        ...
        return MemoryMappedNaiveBayesClassifier(preprocessor: preprocessor, model: model)
    }
...
//        let str = String(bytesNoCopy: <#T##UnsafeMutableRawPointer#>, length: <#T##Int#>, encoding: <#T##String.Encoding#>, freeWhenDone: <#T##Bool#>)
