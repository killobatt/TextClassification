//
//  AdvancedPreprocessorTests.swift
...
class AdvancedPreprocessorTests: XCTestCase {

    var testedPreprocessor: Preprocessor!

    override func setUp() {
        testedPreprocessor = AdvancedPreprocessor()
    }
    ...
    func testPreprocessEmails() {
        // GIVEN
        let text = "Hello, how are you, jackson@example.com doing?"
    ...
    func testPreprocessLinks() {
        // GIVEN
        let text = "Hello, how are you, nshipster.com doing?"
    ...
    func testPreprocessDates() {
        // GIVEN
        let text = "Hello, how are you, 01/01/2001 doing?"
    ...
    func testPreprocessNumbers() {
        // GIVEN
        let text = "Hello, how are you, 123.50 doing 12233?"
    ...
    func testPreprocessNumbersInsideText() {
        // GIVEN
        let text = "Hello1, how1 a1re 1you, 123.50 doing 12233?"
    ...
    func testPerformance() {
        ...
        let loremIpsum = """
            Lorem ipsum dolor sit amet, cu reque contentiones ius, ex sit mucius verear imperdiet, vel graeci scripta ad. Ad has soleat vocibus eleifend, mea no iisque appareat, eu vim possit minimum. Adversarium mediocritatem eum ut. Cum eu democritum abhorreant rationibus, an quem soluta equidem pro. Habeo dissentias mea id, mea cu ullum mentitum@example.com corrumpit. Ullum simul evertitur usu ad, eos tantas repudiare intellegat eu.
            ...
            Id cum amet aperiri, tempor iracundia ut sit, atqui splendide contentiones at vel. His no dolor partiendo, usu id nisl meis nominati. Tempor recteque nec eu, laudem doming eu cum. Quando offendit.org.ua sadipscing mel in, vim ea purto homero placerat. Est ea harum virtute. Tale probatus et pri.

            Ad duo iriure viderer. Nec in fugit 131 eripuit neglegentur. Ad modo nostrum laboramus mei, mea singulis qualisque ad. Mel splendide appellantur no, sint voluptatibus nam ne, te semper tibique ius.

            Ei nec natum graeco facilisi, maiorum 1antiopam percipitur ex ius. No pri suas illum tincidunt. Ea eum menandri recteque, et quo doming nonumes deleniti. Ut quo vidit illum deterruisset, laudem contentiones mei cu. Movet putant repudiandae usu id, alii percipit eu sed.

            Duo ad soluta torquatos, quo ferri facilisis ei. 12 Sit in atqui delenit, purto integre ex usu, at cum erat zril. Causae maluisset ne mea, mei choro prodesset expetendis ea. Ne everti instructior vis, ornatus docendi eleifend ad vix. Sit an equidem singulis pertinacia, probo choro ei usu.
            ...
            Mea ad bonorum dolorem. Ius te quando viderer perpetua. Malis dicunt impedit in est, invenire abhorreant appellantur an has, est ea offendit theophrastus. Paulo malorum copiosae cu nec. Ei prima mucius https://eruditi.eos. Sed an eripuit ullamcorper, mea assum audire bonorum eu.
            ...
            Pri te mazim accommodare, 02/02/2012 nec tempor nominati disputationi ad, solet iudicabit ad pri. Pri no fugit sonet, cu purto dissentias per. Ea erant congue vel. Per nihil zril dolor eu, sed te duis eleifend temporibus. Ferri timeam tibique eu pri, per novum disputando an, mundi audire scriptorem sed ex.
